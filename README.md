...
IP2P é um bot desenvolvido para transmitir e armazenar dados utilizando a infraestrutura de mensagens do Discord.
...
O IP2P explora o Discord como uma infraestrutura de comunicação, transformando um canal de texto em um meio simples para:
- transmissão de dados
- armazenamento de mensagens
- compartilhamento de informações entre usuários ou aplicações
